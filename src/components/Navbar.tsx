  ...
  return (
    <>
      ...
      >
        ...
        {/* Search Bar Overlay */}
        <div
          className={`absolute top-full left-0 right-0 transition-all duration-300 overflow-hidden ${
            isSearchOpen && !isMegaMenuOpen
              ? "max-h-24 opacity-100"
              : "max-h-0 opacity-0 pointer-events-none"
          }`}
        >
          <div
            className={`backdrop-blur-md border-t transition-colors ${
              isScrolled
                ? "bg-white/95 border-gray-200 shadow-lg"
                : "bg-[--color-primary]/95 border-white/10"
            }`}
          >
            <div className="max-w-2xl mx-auto px-4 py-4">
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-12 py-3 rounded-full focus:outline-none transition-all ${
                    isScrolled
                      ? "bg-gray-100 border border-gray-200 text-gray-800 placeholder-gray-400 focus:bg-white focus:border-[--color-primary] focus:ring-2 focus:ring-[--color-primary]/20"
